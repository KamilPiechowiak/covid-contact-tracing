...
class SegmentContactServiceTest {
    ...
    fun transformCoordinates() {
        ...
        val meanLat = (a.latitude+b.latitude)/2.0
    ...
    fun contact() {
       ...
       assertEquals(listOf<GeoPoint>(GeoPoint(latitude= 52.40270078, longitude= 16.95000781, time=520), GeoPoint(latitude= 52.40383318, longitude= 16.94983608, time=550)),
           service.contact(a, b))
    }
